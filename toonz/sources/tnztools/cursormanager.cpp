...
const struct {
  ...
  bool flippable;
    ...
    {ToolCursor::PenTriangleTopLeftCursor, "brush_triangle_top_left", 16, 15,
     false},
    {ToolCursor::PenTriangleTopRightCursor, "brush_triangle_top_right", 16, 15,
     false},
    {ToolCursor::PenTriangleBottomLeftCursor, "brush_triangle_bottom_left", 16,
     15, false},
    ...
    {ToolCursor::PenTriangleLeftCursor, "brush_triangle_left", 16, 15, false},
    {ToolCursor::PenTriangleRightCursor, "brush_triangle_right", 16, 15, false},
