...
public:
  ...
  inline bool getRestrictA() const { return data()[m_idRestrictA].getBool(); }
  inline bool getRestrictB() const { return data()[m_idRestrictB].getBool(); }
...
public:
  ...
  static void drawEllipseRanges(const TAngleRangeSet &ranges,
                                const TAffine &ellipseMatrix,
                                const TAffine &screenMatrixInv,
                                double pixelSize, double alpha);

  static inline void drawEllipse(const TAffine &ellipseMatrix,
                                 const TAffine &screenMatrixInv,
                                 double pixelSize, double alpha) {
  ...
  static void drawRuler(const TAffine &ellipseMatrix, const TPointD &grid0,
                        const TPointD &grid1, bool perspective, double alpha);

  static void drawConcentricGrid(const TAffine &ellipseMatrix,
                                 const TPointD &grid0, const TPointD &grid1,
                                 bool perspective, double alpha);

  static void drawParallelGrid(const TAffine &ellipseMatrix,
                               const TPointD &grid0, const TPointD &grid1,
                               const TPointD *bound0, const TPointD *bound1,
                               bool perspective, bool perspectiveDepth,
                               bool repeat, double alpha);
